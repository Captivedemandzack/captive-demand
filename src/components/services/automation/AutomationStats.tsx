...
const stats = [
    { value: 42, suffix: '+', label: 'Hours Saved Weekly', sublabel: 'per client on average' },
    { value: 127, suffix: '', label: 'Active Workflows', sublabel: 'running across all clients' },
    { value: 98, suffix: '%', label: 'Uptime', sublabel: 'zero missed triggers' },
    { value: 5, suffix: 'x', label: 'ROI', sublabel: 'within first 90 days' },
];
