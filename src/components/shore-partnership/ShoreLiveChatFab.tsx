...
export function ShoreLiveChatFab() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-[70] flex items-center gap-2 rounded-full bg-[#1a1512] py-3 pl-4 pr-5 font-mono text-[11px] uppercase tracking-[0.12em] text-white shadow-[0_4px_24px_rgba(0,0,0,0.18),inset_0_1px_0_0_rgba(255,255,255,0.12)] transition-transform duration-200 hover:scale-[1.03] active:scale-95 max-sm:bottom-4 max-sm:right-4"
